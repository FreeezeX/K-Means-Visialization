...
export default {
  ...
  mounted() {
    ...
    //var root1 = am5.Root.new("wcssdiv");
...
*/
    ...
    ////////////////////////////////////////////////
/*
    var secondContainer = root1.container.children.push(am5.Container.new(root1, {
      width: am5.p100,
      height: am5.p100,
      layout: root.verticalLayout
    }))

    var chrt = secondContainer.children.push(am5xy.XYChart.new(root1, {
      panX: false,
      panY: false,
      wheelX: "panX",
      wheelY: "zoomX"
    ...
    var crsr = chrt.set("cursor", am5xy.XYCursor.new(root1, {
      behavior: "zoomX"
    }));
    crsr.lineY.set("visible", false);
    ...
    var xAxs = chrt.xAxes.push(am5xy.DateAxis.new(root1, {
      maxDeviation: 0,
      baseInterval: {
        timeUnit: "iteration",
        count: 1
    ...
    var yAxs = chrt.yAxes.push(am5xy.ValueAxis.new(root1, {
      renderer: am5xy.AxisRendererY.new(root1, {})
    }));

    var seriesWCSS = chrt.series.push(am5xy.ColumnSeries.new(root1, {
      name: "Series",
      xAxis: xAxs,
      yAxis: yAxs,
      valueYField: "value",
    ...
    chrt.set("scrollbarX", am5.Scrollbar.new(root1, {
      orientation: "horizontal"
    }));

    var dataa = refactorData(yearWCSS);
    seriesWCSS.data.setAll(dataa);

    seriesWCSS.appear(1000);
    chrt.appear(1000, 100);
*/
  },
